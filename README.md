...
| 专家榜评分项 | 项目对应设计 |
|-------------|-------------|
| 鲁棒性 | 62 项测试、异常输入兜底、空输入/仅简历/仅JD/混合语言/Markdown 全覆盖 |
...
| 工程规范 | README、SKILL.md（validate PASS）、pyproject.toml、Makefile、62 tests |
...
- **鲁棒性强**：62 测试覆盖空输入/仅简历/仅JD/格式混乱/中英文混合
- **安全合规**：敏感信息不参与评分
